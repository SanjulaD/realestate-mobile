      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerClassName="pb-32 bg-white">
        ...
        <View className="mt-7 flex gap-2 px-5">
          ...
          <View className="mt-5 flex flex-row items-center">
            ...
            <Text className="ml-2 font-rubik-medium text-sm text-black-300">{property?.bedrooms} Beds</Text>
            <View className="ml-7 flex size-10 flex-row items-center justify-center rounded-full bg-primary-100">
              <Image source={icons.bath} className="size-4" />
            </View>
            <Text className="ml-2 font-rubik-medium text-sm text-black-300">{property?.bathrooms} Baths</Text>
            <View className="ml-7 flex size-10 flex-row items-center justify-center rounded-full bg-primary-100">
              <Image source={icons.area} className="size-4" />
            </View>
            <Text className="ml-2 font-rubik-medium text-sm text-black-300">{property?.area} sqft</Text>
          </View>
            ...
            <View className="mt-4 flex flex-row items-center justify-between">
              <View className="flex flex-row items-center">
                ...
                <View className="ml-3 flex flex-col items-start justify-center">
                  <Text className="text-start font-rubik-bold text-lg text-black-300">{property?.agent.name}</Text>
                  <Text className="text-start font-rubik-medium text-sm text-black-200">{property?.agent.email}</Text>
                </View>
              </View>
          ...
          <View className="mt-7">
            ...
            <Text className="mt-2 font-rubik text-base text-black-200">{property?.description}</Text>
          </View>
          ...
          <View className="mt-7">
            ...
            <Image source={images.map} className="mt-5 h-52 w-full rounded-xl" />
          </View>
      ...
      <View className="absolute bottom-0 w-full rounded-t-2xl border-l border-r border-t border-primary-200 bg-white p-7">
        <View className="flex flex-row items-center justify-between gap-10">
          <View className="flex flex-col items-start">
            ...
            <Text numberOfLines={1} className="text-start font-rubik-bold text-2xl text-primary-300">
              ${property?.price}
            </Text>
          </View>
          ...
          <TouchableOpacity className="flex flex-1 flex-row items-center justify-center rounded-full bg-primary-300 py-3 shadow-md shadow-zinc-400">
            <Text className="text-center font-rubik-bold text-lg text-white">Book Now</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
